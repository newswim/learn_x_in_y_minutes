; CHICKEN is an implementation of Scheme programming language that can compile
; Scheme programs to C code as well as interpret them. CHICKEN supports RSR5 and
; RSR7 (work in progress) standards and many extensions.
